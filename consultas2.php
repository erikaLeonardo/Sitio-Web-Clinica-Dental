    ...
    if(isset($_POST['txtDia'])){
        $fecha = $_POST['txtDia'];
            ...
            echo "<form class='row' form action='validar.php' method='post'>";
                ...
                echo "</div>";
                echo "<div class='col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6 mt-5 pt-4'>";
                echo "<select class='form-select form-select mb-3' aria-label='form-select-lg example' name='cmbhora' size='1'>";
            ...
            <div class="float-end">
            <a class="btn float-end" style="background-color: #d3d3d3" href='pagina-usuario.php'>Cancelar</a>
            <button class="btn float-end me-2" style="background-color: #d3d3d3" type="summit" >Agendar</button>
            </div>
